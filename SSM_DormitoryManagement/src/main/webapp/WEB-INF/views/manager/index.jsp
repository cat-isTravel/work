        ...
        <nav class="layui-layout-right">
            <ul class="layui-nav">
                <li class="layui-nav-item layui-hide-xs"><a
                        href="javascript:">
<%--                   <img src="../static/image/James.jpg" class="layui-nav-img userAvatar" width="35" height="35" />--%>
                    <cite
                        class="adminName">${sessionScope.user.username}</cite>
                </a>
        ...
        <div class="layui-side-scroll">
            <ul class="layui-nav layui-nav-tree" lay-filter="test">
                ...
                <li class="layui-nav-item"><a href="javascript:;"><i
                        class="glyphicon glyphicon-file"></i><span>房间管理</span></a>
                    <dl class="layui-nav-child" style="text-align: center">
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="3"
                               data-title="楼层A" data-url="dorm/A">A栋</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="4"
                               data-title="楼层B" data-url="dorm/B">B栋</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="5"
                               data-title="楼层C" data-url="dorm/C">C栋</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="6"
                               data-title="楼层D" data-url="dorm/D">D栋</a>
                        </dd>
                    </dl></li>
                <li class="layui-nav-item"><a href="javascript:;"><i
                        class="glyphicon glyphicon-list"></i><span>宿舍信息</span></a>
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="7"
                               data-title="学生宿舍" data-url="list">学生宿舍信息</a>
                        </dd>
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="8"
                               data-title="教师宿舍" data-url="tea">教职工宿舍信息</a>
                        </dd>
                    </dl></li>
                <li class="layui-nav-item"><a href="javascript:;"><i
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="9"
                               data-title="用户管理" data-url="user">用户管理</a>
                        </dd>
                    </dl></li>
                <li class="layui-nav-item"><a href="javascript:;"><i
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="site-url" data-id="10"
                               data-title="维修服务" data-url="service">维修服务</a>
                        </dd>
                    </dl></li>
                <li class="layui-nav-item"><a href="javascript:;"><i
