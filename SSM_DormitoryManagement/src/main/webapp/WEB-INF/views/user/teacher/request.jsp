    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="tea_order">生成订单</button>
            </div>
        </div>
    </div>
</div>
...
<div class="row" style="margin-top: 10px">
    <div class="col-md-12">
        <table class="table table-bordered" id="tea_request_table">
            <thead>
                <th>服务订单号</th>
                <th>用户名</th>
                <th>申请房间号</th>
...
<script>
    ...
    function bulid_table(result){
        $.each(result.extend.pageInfo.list,function (index, item) {
            ...
            $("<tr></tr>")
                ...
                .append(state)
                .append(del_td)
                .appendTo("#tea_request_table tbody")
        });
    }
    ...
    $("#tea_order").click(function () {
       // alert($("#tea_order_form").serialize());
        ...
        $.ajax({
          url:"ord",
          type: "POST",
          data: $("#tea_order_form").serialize()+"&user="+user+"&dormNum="+dorm_num,
          success:function (result) {
            if (result.code == 100){
                alert("成功");
                to_pageNum(9999999);
    ...
    $(document).on("click",".delete_btn",function () {
        var orderId = $("#tea_request_table").parent().parent().find("td:eq(0)").text();
