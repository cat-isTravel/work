...
<div class="row">
    <div class="col-md-4 col-md-offset-4">
        <div class="input-group">
            <input type="text" class="form-control" placeholder=" &nbsp;房间号" id="select_dorm_num_inp">
            <span class="input-group-btn">
        <button class="btn btn-default" type="button" id="select_dorm_numBT">Go!</button>
      </span>
        </div>
    </div>
    <div class="row">
...
<script>
    ...
    $("#select_dorm_num").click(function () {
        var dorm_num = $("#select_dorm_num_inp").val();
        $.ajax({
            url: "",
            type:"",
            data: "",
