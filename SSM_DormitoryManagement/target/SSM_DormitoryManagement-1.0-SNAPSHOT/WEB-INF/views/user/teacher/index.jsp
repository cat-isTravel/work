          ...
          <dl class="layui-nav-child">
            <dd>
              <a href="javascript:;" class="site-url" data-id="3"
                 data-title="我的舍友" data-url="teaRoommate">我的舍友</a>
            </dd>
          </dl></li>
        <li class="layui-nav-item"><a href="javascript:;"><i
          ...
          <dl class="layui-nav-child">
            <dd>
              <a href="javascript:;" class="site-url" data-id="4"
                 data-title="房间信息" data-url="teaRoomInfo">房间信息</a>
            </dd>
          </dl></li>
        <li class="layui-nav-item"><a href="javascript:;"><i
          ...
          <dl class="layui-nav-child">
            <dd>
              <a href="javascript:;" class="site-url" data-id="5"
                 data-title="用户信息" data-url="teaUserInfo">用户信息</a>
            </dd>
          </dl></li>
        <li class="layui-nav-item"><a href="javascript:;"><i
          ...
          <dl class="layui-nav-child">
            <dd>
              <a href="javascript:;" class="site-url" data-id="6"
                 data-title="维修申请" data-url="teaRequest">维修申请</a>
            </dd>
          </dl></li>
        <li class="layui-nav-item"><a href="javascript:;"><i
